        ...
        {authAdmin() || authAnalista() ? (
          <div>
            ...
            <div className="container" style={{ color: "#424B5A;" }}>
              ...
              />
              <RegistroMasivo
                subtitulo="Adjunta el archivo .xlsx con la información básica de los servicios a actualizar."
                subtitulo2="Descarga el historico anual de anomalia de servicios."
                descarga={true}
              />
              ...
              <div className="container" style={{ color: "#424B5A" }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      Ingresa la información de la anomalía a registrar del
                      servicio.
                      <br />
                    </p>
                    <div
                        ...
                        <div className="mb-3" style={{ fontSize: "12px" }}>
                          ...
                          >
                            <optgroup label="Anomalías">
                              <option value="Medidor dañado" selected="">
                                Medidor dañado
                              </option>
