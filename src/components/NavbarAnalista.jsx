        ...
        <React.Fragment>
            <nav className="navbar navbar-light navbar-expand-lg navigation-clean-button" style={{color: "#424B5A",background: "#F2F5F7",marginBottom: "36px"}}>
                <div className="container">
                    <a className="navbar-brand"  style={{color: "#424B5A"}}>GASES DEL CARIBE</a>
                    <div>
                            ...
                            <ul className="navbar-nav me-auto">
                                <li className="nav-item dropdown">
                                    ...
                                    <div className="dropdown-menu shadow-none" style={{fontSize: "12PX"}}>
                                        <Link to='/ServiciosRegistro' className="dropdown-item" style={{fonSize: "12PX"}}>Registro</Link>
                                        <Link to='/ServiciosGestion' className="dropdown-item" style={{fontSize: "12PX"}}>Gestión</Link></div>
                                </li>
                                <li className="nav-item" style={{fontSize: "12PX"}}>
                                    <Link to='/Facturacion' className="nav-link" style={{fontize: "12PX"}}>FACTURACIÓN</Link>
                                </li>
                                <li className="nav-item" style={{fontSize: "12PX"}}>
                    ...
                    <button data-bs-target="#navcol-1" data-bs-toggle="collapse" className="navbar-toggler"><span className="visually-hidden">Toggle navigation</span>
